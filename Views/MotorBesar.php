...
$motorManager = new MotorBesar($db->aksesKoneksi());
$daftarMotor = $motorManager->tampilkanSemuaData();
$no = 1;
...
<div class="px-3 sm:px-5 lg:px-6">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-sm font-semibold text-gray-900 dark:text-white">Daftar Motor Besar</h1>
            <p class="mt-1 text-xs text-gray-700 dark:text-gray-300">Daftar motor besar yang dikelola melalui
                implementasi abstract class dan database.</p>
        </div>
    </div>
            ...
            <div class="inline-block min-w-full py-2 align-middle">
                <table class="min-w-full border-separate border-spacing-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td
                                class="<?php echo $borderClass; ?> py-3 pr-2 pl-3 text-xs font-medium whitespace-nowrap text-gray-900 sm:pl-5 lg:pl-6 dark:text-white">
                                <?php echo $no++; ?>
                            </td>
                            <td
                                class="<?php echo $borderClass; ?> px-2 py-3 text-xs whitespace-nowrap text-gray-500 dark:text-gray-400">
                                <?php echo htmlspecialchars($m->aksesIDkendaraan()); ?>
                            </td>
                            <td
                                class="<?php echo $borderClass; ?> px-2 py-3 text-xs whitespace-nowrap text-gray-900 font-medium dark:text-white">
                            ...
                            <td
                                class="<?php echo $borderClass; ?> px-2 py-3 text-xs whitespace-nowrap text-gray-500 dark:text-gray-400 italic">
                                <?php 
                                        // Memanggil method spesifikasi dari objek
                                        $m->tampilData(); 
                                    ?>
                            </td>
                        </tr>
                        ...
                        <?php else : ?>
                        <tr>
                            <td colspan="7" class="py-8 text-center text-sm text-gray-500 dark:text-gray-400 italic">
